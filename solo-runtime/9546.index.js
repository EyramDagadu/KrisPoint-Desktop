export const id = 9546;
export const ids = [9546];
...
/* harmony export */ });
/* harmony import */ var _chunks_attributes_js_BJlrMZid_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(89831);
/* harmony import */ var _chunks_state_svelte_js_Cm6uwfjG_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42299);
...
/* harmony import */ var _chunks_index_js_BPHC9uE5_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(34899);
...
function r(){return (0,_chunks_index_js_BPHC9uE5_js__WEBPACK_IMPORTED_MODULE_6__.a3)("__request__")}const a={get error(){return r().page.error},get status(){return r().page.status}},e=a;function x(o,m){o.component(p=>{p.push(`<h1>${(0,_chunks_attributes_js_BJlrMZid_js__WEBPACK_IMPORTED_MODULE_0__.P)(e.status)}</h1> <p>${(0,_chunks_attributes_js_BJlrMZid_js__WEBPACK_IMPORTED_MODULE_0__.P)(e.error?.message)}</p>`);});}


//# sourceMappingURL=error.svelte.js-DFN0UVc7.js.map
