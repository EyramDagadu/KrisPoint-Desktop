...
declare module '$env/static/private' {
	...
	export const PAYSTACK_TEST_SECRET_KEY: string;
	...
	export const LICENSE_SERVER_PORT: string;
	...
	export const PAYSTACK_TEST_API_KEY: string;
	export const AUDIT_SECRET: string;
